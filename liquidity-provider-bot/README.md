...
Automated liquidity provider and market maker for the Polymarket CLOB (Rust implementation).
...
- To build: `docker build -t liquidity-provider-bot .`
- To run: `docker run liquidity-provider-bot`
